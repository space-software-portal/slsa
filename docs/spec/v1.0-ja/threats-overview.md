...
This page is an introduction to possible attacks throughout the supply chain and how SLSA can help. For a more technical discussion, see [Threats & mitigations](threats.md).

## Summary

![Supply Chain Threats](../../images/v1.0/supply-chain-threats.svg)

See [Terminology](terminology.md) for an explanation of the supply chain model.
